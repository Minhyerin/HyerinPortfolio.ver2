...
export const WorkData = [
  {
    ...
    desc: [
      "산후조리원 산모들을 대상으로 한 쇼핑몰 웹사이트로 PC와 모바일 사이트 두가지를 제작하였습니다.",
      "임산부 코드를 입력하여 가입 및 로그인이 가능하고, 산후조리원과 연계된 시스템으로 하루배송이 가능하고 산모들을 필요한 유기농식료품이나 용품들을 바로 받아 볼 수 있습니다.",
    ],
    detail: [
      "상단 헤더와 푸터 디자인과 코딩, 슬라이드 배너 이미지 디자인 및 전반적인 레이아웃 디자인 하였습니다. 지정된 아이디와 비밀번호로 로그인을 해야 제품의 금액과 상세페이지를 볼 수 있습니다.",
    ],
  },
  {
    id: 2,
    ...
    info: "앞서 제작한 Hugmom 프로젝트를 리엑트를 활용하여 재구성 하였습니다. 리덕스를 활용하여 데이터 상태관리를 보다 효율적으로 사용하는 법을 익히고, netlify를 통해 배포하였습니다. JSON 파일을 가상 서버를 활용하여 데이터를 가져와 출력해 주도록 하였습니다.",
    imgs: [],
    figma: "",
  },
  {
